...
26. **Floating tab bar (premium):** Absolute solid floating card (Content sichtbar darunter), Spring-Physics für Pill-Slide + Soft-Morph, Press-Scale 0.94, Icon-Focus-Scale 1.08 — `FloatingTabBar` + `FLOATING_TAB_BAR_CLEARANCE` auf Tab-Screens.
