...
const CLIPS = [
  ...
  ['onboarding.proof.playful', 'Schau, wie der vage Prompt besser wird — das ist der Skill.', 'playful'],
  ['onboarding.proofDone.playful', 'Stark — du erkennst schwache Prompts und kannst sie fixen.', 'playful'],
  ...
  ['onboarding.proof.focus', 'Kritik, Rewrite, Vergleich. Das ist der Beweis.', 'focus'],
  ['onboarding.proofDone.focus', 'Du kannst aus einer vagen Bitte ein brauchbares Briefing machen.', 'focus'],
