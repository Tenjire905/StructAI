...
export const copyRu: CopyCatalog = {
  ...
  'sessionSkill.generic.proof': {
    playful: 'Ты отработал конкретный паттерн промптинга, который можно взять в следующую задачу с ИИ.',
    focus: 'Ты отработал повторно используемый паттерн промптинга для следующей задачи с ИИ.',
  },
  'sessionSkill.pb-1.name': {
    playful: 'Понять, что такое промпт на самом деле',
    focus: 'Определить промпт как бриф',
  },
  'sessionSkill.pb-1.proof': {
    playful: 'Ты отличаешь смутное желание от рабочей инструкции — первый шаг к лучшим ответам ИИ.',
    focus: 'Ты отличаешь смутное желание от рабочей инструкции для модели.',
  },
  'sessionSkill.pb-2.name': {
    playful: 'Вложить в промпт ясную цель',
    focus: 'Сформулировать явную цель',
  },
  'sessionSkill.pb-2.proof': {
    playful: 'Ты понимаешь, почему «сделай что-нибудь» ломается — и как назвать нужный результат.',
    focus: 'Ты называешь желаемый результат вместо размытой просьбы.',
  },
  'sessionSkill.pb-3.name': {
    playful: 'Дать модели нужный контекст',
    focus: 'Предоставить необходимый контекст',
  },
  'sessionSkill.pb-3.proof': {
    playful: 'Ты видишь, когда промпту мало контекста и что добавить перед отправкой.',
    focus: 'Ты находишь недостающий контекст до отправки промпта.',
  },
  'sessionSkill.pb-4.name': {
    playful: 'Выбрать роль и аудиторию',
    focus: 'Задать роль и аудиторию',
  },
  'sessionSkill.pb-4.proof': {
    playful: 'Ты направляешь тон и экспертизу, назначая роль и указывая, для кого ответ.',
    focus: 'Ты управляешь выводом через роль и аудиторию.',
  },
  'sessionSkill.pb-5.name': {
    playful: 'Сознательно ограничить формат',
